...
namespace PersonalBlog.Data.Migrations
{
    ...
    [Migration("20220809142941_002-modifiedBlogPostModel")]
    partial class _002modifiedBlogPostModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalBlog.Models.BlogUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BlogPostTag", b =>
                {
                    b.HasOne("PersonalBlog.Models.BlogPost", null)
                        .WithMany()
                        .HasForeignKey("BlogPostsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PersonalBlog.Models.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PersonalBlog.Models.BlogUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PersonalBlog.Models.Comment", b =>
                {
                    b.HasOne("PersonalBlog.Models.BlogUser", "Author")
                        .WithMany("Comments")
